...
dd_5 <- complete_total %>% lm(incidencia ~ cb_1+inicio_cb1+cb_1*inicio_cb1 + POB2010,.)
# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("CB L1","Start L1","Population 2010","L1 X Start"),
...
dd_5 <- complete_total %>% lm(incidencia ~ cb_2+inicio_cb2+cb_2*inicio_cb2 + POB2010,.)

# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("CB L2","Start L2","Population 2010","L2 X Start"),
          dep.var.labels = "|1 = Choque Sin lesionados | 2 = Choque con Lesionados | 3  = Atropellado Lesionado | 4 = Accidente de Moto | 5 = Total Incidentes |", 
...
dd_5 <- complete_total %>% lm(incidencia ~ tr_9+inicio_l9+tr_9*inicio_l9 + POB2010,.)

# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("Trolebus L9","Start L9","Population 2010","L9 X Start"),
          dep.var.labels = "|1 = Choque Sin lesionados | 2 = Choque con Lesionados | 3  = Atropellado Lesionado | 4 = Accidente de Moto | 5 = Total Incidentes", 
...
dd_5 <- complete_total %>% lm(incidencia ~ tr_e+inicio_te+tr_e*inicio_te + POB2010,.)

# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("Trolebus Elevado","Start","Population 2010","TRE X Start"),
...
dd_5 <- complete_total %>% lm(incidencia ~ l_1+para_l1+l_1*para_l1 + POB2010,.)
# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("STC L1","Stop L1","Population 2010","L1 X Stop"),
          dep.var.labels = "|1 = Choque Sin lesionados | 2 = Choque con Lesionados | 3  = Atropellado Lesionado | 4 = Accidente de Moto | 5 = Incidentes Totales |", 
...
dd_5 <- complete_total %>% lm(incidencia ~ l_12+para_l12+l_12*para_l12 + POB2010,.)
# Tabla
stargazer(dd_1,dd_2,dd_3,dd_4,dd_5, type = "text", digits = 2, covariate.labels = c("STC L12","Stop L12","Population 2010","L12 X Stop"),
          dep.var.labels = "|1 = Choque Sin lesionados | 2 = Choque con Lesionados | 3  = Atropellado Lesionado | 4 = Accidente de Moto | 5 = Incidentes Totales |", 
